{ inputs, config, pkgs, ... }: {
  ...
  programs.nixvim = {
    ...
    editor = {
      ...
      opts = {
        swapfile = true;
        directory = "/home/bluecosmo/.local/state/nvim/swap//";
      };
    };

    plugins = [
      inputs.nixvim.plugins.airline
      inputs.nixvim.plugins.treesitter
      inputs.nixvim.plugins.telescope
      inputs.nixvim.plugins.lsp
      inputs.nixvim.plugins.notify
    ];
  };
